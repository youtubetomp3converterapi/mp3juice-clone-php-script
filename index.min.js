    ...
    */
    ...
    var r = n(19),
        ...
        u = new o.a({
            ...
            use: "icon-play-usage",
            viewBox: "0 0 24 24",
            content: '<symbol fill="#ffffff" viewBox="0 0 24 24" id="icon-play">\n  <path d="M0 0h24v24H0z" fill="none" />\n  <path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />\n</symbol>'
        });
    a.a.add(u);
    e.default = u
}, function(t, e, n) {
                    ...
                    return i.default.wrap(function(t) {
                        for (;;) switch (t.prev = t.next) {
                            case 0:
                                ...
                                return t.abrupt("return", alert("Please select a valid audio file"));
                            case 2:
                                return n.setState({
                                    file: r,
                                    paused: !0,
        ...
        return (0, m.default)(e, t), (0, d.default)(e, [{
            ...
            value: function() {
                ...
                return b.default.createElement("div", {
                    ...
                    className: "app-title"
                }, "Desktop MP3 Cutter"), this.state.decoding ? b.default.createElement("div", {
                    className: "player player-landing"
                }, "Our Magic is coming...") : b.default.createElement(M.default, {
                    ...
                    className: "landing"
                }, b.default.createElement("h2", null, "Desktop MP3 Cutter"), b.default.createElement(O.default, {
                    onChange: this.handleFileChange
                }, b.default.createElement("div", {
                    className: "file-main"
                }, b.default.createElement(C.default, {
    ...
    e = t.exports = n(167)(!1), e.push([t.i, 'body,html{height:100%}.btn-reset,.ctrl-item,.dropdown .list a{padding:0;border:0;outline:0;background:none}.container{box-sizing:border-box;position:relative;width:1080px;margin:0 auto;padding:40px}.app-title{text-align:center;color:#ffffff;font-size:40px;left:0;right:0;top:-135px}.player{position:relative;margin:0 auto;height:160px;display:block;box-shadow:0 0 30px rgba(0,0,0,.1)}.player .wave-canvas{position:absolute}.player-landing{text-align:center;display:flex;flex-direction:column;justify-content:center;color:#ddd;font-size:24px}.dragger{width:1px;background:#e2e2e2;cursor:col-resize}.dragger,.dragger:after{position:absolute;top:0;bottom:0}.dragger:after{content:"";left:-2px;right:-2px}.dragger:hover{background:#333}.drag-current{background:#0cf}.landing{padding-bottom:100px}.landing h2{padding:0;margin:0;text-align:center;color:#ffffff;font-size:40px;margin-bottom:40px}.controllers{margin-top:10px}.controllers .seconds{font-size:12px;line-height:36px;margin-left:10px;display:inline-block;overflow:hidden;color:#e8e6e6}.file input{visibility:hidden;position:absolute}.file-main{display:block;margin:0 auto;padding:40px;text-align:center;cursor:pointer;color:#e2e2e2;transition:.3s;background:none;box-shadow:0 0 20px rgba(0,0,0,.1)}.file-main .icon{margin:-1px 5px 0;font-size:24px}.file-main:hover{color:#6ac;border-color:#6ac}.icon{width:1em;height:1em;fill:currentColor;vertical-align:middle}@keyframes spin{0%{transform:rotate(0)}to{transform:rotate(1turn)}}.icon-spin{animation:spin infinite 1s linear}.ctrl-item{display:inline-block;font-size:16px;text-align:center;color:#e2e2e2;padding:10px;margin-right:10px;box-shadow:0 0 15px rgba(0,0,0,.1);cursor:pointer}.ctrl-item:hover{box-shadow:0 0 20px rgba(0,0,0,.16)}.ctrl-item .icon{display:block}.dropdown{display:inline-block}.dropdown,.dropdown .list-wrap{position:relative}.dropdown .list{position:absolute;width:60px;top:0;left:0;visibility:hidden;opacity:0;transition-duration:.3s;transition-property:opacity,visibility;list-style:none;background:#fff;box-shadow:0 0 15px rgba(0,0,0,.2);padding:0;margin:0;z-index:10}.dropdown .list a{display:block;width:100%;text-align:center;padding:5px 0;color:inherit;font-size:12px;cursor:pointer}.dropdown .list a:hover{background:#333;color:#fff}.dropdown:hover .list{opacity:1;visibility:visible}.clipper{position:absolute;width:100%;height:100%}.cursor-current{position:absolute;font-size:12px;top:-22px;padding:1px 3px;text-align:center;color:#fff;transform:translate(-50%) scale(.8);background:#0cf}.cursor-current .num{font-family:monospace}.cursor-current:after{content:"";position:absolute;border:5px solid transparent;border-top-color:#0cf;bottom:-9px;left:50%;margin-left:-5px}', ""])
}, function(t, e) {
    function n(t, e) {
        var n = t[1] || "",
            o = t[3];
